...
const TERMS: Record<Lang, { title: string; intro: string; sections: Section[] }> = {
  PT: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Os produtos são expedidos para Portugal Continental e, mediante consulta prévia, para a União Europeia, através das transportadoras GLS e CTT. O prazo de entrega habitual é de 3 a 7 dias úteis após confirmação do pagamento.",
          "Os portes de envio para Portugal Continental são calculados com base no peso da encomenda e apresentados antes da finalização da compra, sendo gratuitos em encomendas de valor igual ou superior a €100. Em encomendas internacionais, os portes são gratuitos a partir de €75; abaixo desse valor, dependem do volume e do peso da encomenda, sendo igualmente calculados e apresentados antes da finalização da compra. A Empresa não é responsável por atrasos imputáveis às transportadoras.",
        ],
      },
      {
  ...
  EN: {
    ...
    sections: [
      ...
      { h: "5. Delivery and shipping", p: ["Products are shipped to Mainland Portugal and, upon prior arrangement, to the European Union, via the carriers GLS and CTT. Typical delivery time is 3 to 7 business days after payment confirmation.", "Shipping costs to Mainland Portugal are calculated based on the order's weight and shown before order completion, and are free on orders of €100 or more. On international orders, shipping is free from €75; below that amount, costs depend on the package volume and weight and are likewise calculated and shown before order completion. The Company is not liable for delays attributable to the carriers."] },
  ...
  DE: {
    ...
    sections: [
      ...
      { h: "5. Lieferung und Versand", p: ["Versand nach Festland-Portugal und – nach vorheriger Absprache – in die EU, über die Versanddienstleister GLS und CTT. Übliche Lieferzeit: 3 bis 7 Werktage nach Zahlungseingang.", "Die Versandkosten nach Festland-Portugal werden auf Basis des Gewichts der Bestellung berechnet und vor Bestellabschluss angezeigt; ab einem Bestellwert von €100 ist der Versand kostenlos. Bei internationalen Bestellungen ist der Versand ab €75 kostenlos; darunter richten sich die Versandkosten nach Volumen und Gewicht des Pakets und werden ebenfalls vor Bestellabschluss berechnet und angezeigt. Wir haften nicht für Verzögerungen durch die Transportunternehmen."] },
  ...
  NL: {
    ...
    sections: [
      ...
      { h: "5. Levering en verzending", p: ["Verzending naar het Portugese vasteland en, na overleg, naar de EU, via de vervoerders GLS en CTT. De gebruikelijke leveringstijd is 3 tot 7 werkdagen na betalingsbevestiging.", "Verzendkosten naar het Portugese vasteland worden berekend op basis van het gewicht van de bestelling en getoond vóór afronding van de bestelling, en zijn gratis vanaf een bestelwaarde van €100. Bij internationale bestellingen is verzending gratis vanaf €75; daaronder zijn de verzendkosten afhankelijk van het volume en gewicht van het pakket en worden ze eveneens vóór afronding van de bestelling berekend en getoond. Wij zijn niet aansprakelijk voor vertragingen door de vervoerders."] },
