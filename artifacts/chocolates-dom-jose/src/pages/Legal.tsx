...
const TERMS: Record<Lang, { title: string; intro: string; sections: Section[] }> = {
  PT: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Os produtos são expedidos apenas para Portugal Continental, através das transportadoras GLS e CTT. O prazo de entrega habitual é de 3 a 7 dias úteis após confirmação do pagamento.",
          "Os portes de envio são calculados com base no peso da encomenda e apresentados antes da finalização da compra, sendo gratuitos em encomendas de valor igual ou superior a €100. A Empresa não é responsável por atrasos imputáveis à transportadora.",
        ],
      },
      {
  ...
  EN: {
    ...
    sections: [
      ...
      { h: "5. Delivery and shipping", p: ["Products are shipped to Mainland Portugal only, via the carriers GLS and CTT. Typical delivery time is 3 to 7 business days after payment confirmation.", "Shipping costs are calculated based on the order's weight and shown before order completion, and are free on orders of €100 or more. The Company is not liable for delays attributable to the carriers."] },
  ...
  DE: {
    ...
    sections: [
      ...
      { h: "5. Lieferung und Versand", p: ["Versand ausschließlich nach Festland-Portugal, über die Versanddienstleister GLS und CTT. Übliche Lieferzeit: 3 bis 7 Werktage nach Zahlungseingang.", "Die Versandkosten werden auf Basis des Gewichts der Bestellung berechnet und vor Bestellabschluss angezeigt; ab einem Bestellwert von €100 ist der Versand kostenlos. Wir haften nicht für Verzögerungen durch die Transportunternehmen."] },
  ...
  NL: {
    ...
    sections: [
      ...
      { h: "5. Levering en verzending", p: ["Verzending uitsluitend naar het Portugese vasteland, via de vervoerders GLS en CTT. De gebruikelijke leveringstijd is 3 tot 7 werkdagen na betalingsbevestiging.", "Verzendkosten worden berekend op basis van het gewicht van de bestelling en getoond vóór afronding van de bestelling, en zijn gratis vanaf een bestelwaarde van €100. Wij zijn niet aansprakelijk voor vertragingen door de vervoerders."] },
