...
const TERMS: Record<Lang, { title: string; intro: string; sections: Section[] }> = {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "Os portes de envio são gratuitos em Portugal Continental e em encomendas internacionais de valor igual ou superior a €75. Abaixo desse valor, os portes para envios internacionais dependem do volume e do peso da encomenda, sendo calculados e apresentados antes da finalização da compra. A Empresa não é responsável por atrasos imputáveis às transportadoras.",
        ],
      },
      {
  ...
  EN: {
    ...
    sections: [
      ...
      { h: "5. Delivery and shipping", p: ["Products are shipped to Mainland Portugal and, upon prior arrangement, to the European Union, via the carriers GLS and CTT. Typical delivery time is 3 to 7 business days after payment confirmation.", "Shipping is free within Mainland Portugal and on international orders of €75 or more. Below that amount, international shipping costs depend on the package volume and weight and are calculated and shown before order completion. The Company is not liable for delays attributable to the carriers."] },
  ...
  DE: {
    ...
    sections: [
      ...
      { h: "5. Lieferung und Versand", p: ["Versand nach Festland-Portugal und – nach vorheriger Absprache – in die EU, über die Versanddienstleister GLS und CTT. Übliche Lieferzeit: 3 bis 7 Werktage nach Zahlungseingang.", "Der Versand ist innerhalb von Festland-Portugal und bei internationalen Bestellungen ab €75 kostenlos. Darunter richten sich die internationalen Versandkosten nach Volumen und Gewicht des Pakets und werden vor Bestellabschluss berechnet und angezeigt. Wir haften nicht für Verzögerungen durch die Transportunternehmen."] },
  ...
  NL: {
    ...
    sections: [
      ...
      { h: "5. Levering en verzending", p: ["Verzending naar het Portugese vasteland en, na overleg, naar de EU, via de vervoerders GLS en CTT. De gebruikelijke leveringstijd is 3 tot 7 werkdagen na betalingsbevestiging.", "Verzending is gratis binnen het Portugese vasteland en bij internationale bestellingen vanaf €75. Daaronder zijn de internationale verzendkosten afhankelijk van het volume en gewicht van het pakket en worden ze vóór afronding van de bestelling berekend en getoond. Wij zijn niet aansprakelijk voor vertragingen door de vervoerders."] },
