...
const TERMS: Record<Lang, { title: string; intro: string; sections: Section[] }> = {
  PT: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Os produtos são expedidos para Portugal Continental e, mediante consulta prévia, para a União Europeia. O prazo de entrega habitual é de 3 a 7 dias úteis após confirmação do pagamento.",
          "Os custos de envio, quando aplicáveis, são apresentados antes da finalização da encomenda. A Empresa não é responsável por atrasos imputáveis aos operadores logísticos.",
        ],
      },
      {
  ...
  EN: {
    ...
    sections: [
      ...
      { h: "5. Delivery and shipping", p: ["Products are shipped to Mainland Portugal and, upon prior arrangement, to the European Union. Typical delivery time is 3 to 7 business days after payment confirmation.", "Shipping costs, where applicable, are shown before order completion. The Company is not liable for delays attributable to carriers."] },
  ...
  DE: {
    ...
    sections: [
      ...
      { h: "5. Lieferung und Versand", p: ["Versand nach Festland-Portugal und – nach vorheriger Absprache – in die EU. Übliche Lieferzeit: 3 bis 7 Werktage nach Zahlungseingang.", "Eventuelle Versandkosten werden vor Bestellabschluss angezeigt. Wir haften nicht für Verzögerungen durch Logistikdienstleister."] },
  ...
  NL: {
    ...
    sections: [
      ...
      { h: "5. Levering en verzending", p: ["Verzending naar het Portugese vasteland en, na overleg, naar de EU. De gebruikelijke leveringstijd is 3 tot 7 werkdagen na betalingsbevestiging.", "Eventuele verzendkosten worden voor afronding van de bestelling getoond. Wij zijn niet aansprakelijk voor vertragingen door vervoerders."] },
