  ...
  return (
    <div className="min-h-screen bg-[#0f0a07] text-white">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:bg-[#1ebe5d] hover:scale-110 active:scale-95"
      >
